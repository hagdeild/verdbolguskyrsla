...
::: {.card}
Olíuverð hefur hækkað skarpt frá 26. febrúar. Tunnan af brent olíu var um 71 dollari en er nú um 83 sem er hækkun uppá tæp 15%. Enn er óljóst um framhaldið. Verður hækkunin tímabundin eða mun hún vara í lengri tíma.

Í greiningunni er stuðst við tölfræðilíkan sérhannað til að svara því hvernig verðbólga á Íslandi gæti þróast m.v. ólíkar forsendur olíuverðs á heimsmarkaði. Líkanði tekur tillit til annarra þátta á borð við gengi krónunnar og atvinnuleysi.
...
# sviðsmyndir
svidsmyndir_tbl <- read_csv("data/greiningar/oliuverd_scenarios_var.csv") |>
...
p_greining_oliuverd <- spar_udpate_tbl |>
  ...
  geom_line() +
  scale_linetype_manual(values = c("Grunnspá" = "dashed", "Söguleg" = "solid", "+10%" = "solid", "+15%" = "solid", "+20%" = "solid", "+30%" = "solid")) +
  scale_color_manual(values = c("Söguleg" = "black", "Grunnspá" = "black", setNames(blue_palette[2:5], c("+10%", "+15%", "+20%", "+30%")))) +
  facet_wrap(~duration) +
  #theme_minimal() +
  theme(
    legend.title = element_blank(),
