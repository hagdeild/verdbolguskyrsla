...
# VR plot layout
vr_layout <- function(plot, title_x = NULL, textposition = NULL, tooltip = NULL) {
...
vr_layout(p_undir_1, textposition = c("middle right", "middle left"), title_x = 0)
```
...
vr_layout(p_top10_12m, title_x = 0)
...
vr_layout(p_botn_12m, title_x = 0)
```
...
vr_layout(p_top10_1m, title_x = 0)
