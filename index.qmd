...
# sviðsmyndir
svidsmyndir_tbl <- read_csv("c:/Users/vidar/Documents/Rwd/hagrannsoknir/output/oliuverd/scenarios.csv") |>
...
p_greining_oliuverd <- spar_udpate_tbl |>
  ...
  scale_color_manual(values = c("Söguleg" = "black", setNames(vr_litir[1:5], c("Grunnspá", "+10%", "+15%", "+20%", "+30%")))) +
  facet_wrap(~duration) +
  theme_minimal() +
  theme(
    legend.title = element_blank()
...
::: {.card}
Olíuverð hefur hækkað skarpt frá 27. febrúar. Tunnan af brent olíu var um 71 dollari en er nú um 83 sem er hækkun uppá 17%. Enn er óljóst um framhaldið. Verður hækkunin tímabundin eða mun hún vara í mánuði.

Í greiningunni er stuðst við tölfræðilíkan sérhannað til að svara því hvernig verðbólga á Íslandi gæti þróast m.v. ólíkar forsendur olíuverðs á heimsmarkaði. 
...
oliuverd_tbl <- read_csv("data/oliuverd.csv")
...
p_oil <- oliuverd_tbl |> 
  ...
  geom_line() + 
  theme_minimal() +
  labs(x = NULL, y = NULL, title = "Heimsmarkasðverð á olíu (Brent)")
